...
const Aside = ( ) => {
    ...
    return (
        <div className="aside container-sm d-none d-md-flex" style={{maxWidth:'300px', display:'flex', flexDirection:'column', gap:'20px'}}>

                <div >
                    <form action="/" method="get">
                        <input type="search" name="userquestions" placeholder=" To search type and press enter" className="rounded w-100"/>
                    </form>
                ...
                <div>
                    ...
                    <img src={img7} alt="a book called Baesics" style={{maxWidth:'270px', maxHeight:'270px' }} />
                </div>
                <div>
                    <h3>
                ...
                <div>
                    ...
                    <form action="/" method="post">
                        ...
                        <label htmlFor="other name">Other name:</label> <br />
                        <input type="text" name="otherName" placeholder="other name" /> <br />
                        <label htmlFor="mobile number"> Modile number:</label> <br />
                ...
                <div>
                    <h3>BUY A BOOK</h3>
                    <img src= {img9} alt=" abook with atitle of Holy Joe" style={{maxWidth:'200px', maxHeight:'200px' }}/>
